...
}`,...(N=(p=s.parameters)==null?void 0:p.docs)==null?void 0:N.source}}};var g,j,B;o.parameters={...o.parameters,docs:{...(g=o.parameters)==null?void 0:g.docs,source:{originalSource:`args => {
...
}`,...(B=(j=o.parameters)==null?void 0:j.docs)==null?void 0:B.source}}};var h,z,b;r.parameters={...r.parameters,docs:{...(h=r.parameters)==null?void 0:h.docs,source:{originalSource:`args => {
  return <Pagination {...args}>
      <Button className="join-item">1</Button>
...
}`,...(b=(z=r.parameters)==null?void 0:z.docs)==null?void 0:b.source}}};var P,f,v;l.parameters={...l.parameters,docs:{...(P=l.parameters)==null?void 0:P.docs,source:{originalSource:`args => {
  return <Pagination {...args}>
      <Button className="join-item">«</Button>
      <Button className="join-item">Page 22</Button>
      <Button className="join-item">»</Button>
    </Pagination>;
}`,...(v=(f=l.parameters)==null?void 0:f.docs)==null?void 0:v.source}}};var y,x,_;m.parameters={...m.parameters,docs:{...(y=m.parameters)==null?void 0:y.docs,source:{originalSource:`args => {
  return <Pagination {...args}>
...
}`,...(_=(x=m.parameters)==null?void 0:x.docs)==null?void 0:_.source}}};var q,S,V;c.parameters={...c.parameters,docs:{...(q=c.parameters)==null?void 0:q.docs,source:{originalSource:`args => {
  return <Pagination {...args}>
...
}`,...(V=(S=c.parameters)==null?void 0:S.docs)==null?void 0:V.source}}};const J=["Default","Sizes","DisabledButton","ExtraSmallButtons","NextPrevOutlineButtonsWithEqualWidth","UsingRadioInputs"];export{s as Default,r as DisabledButton,l as ExtraSmallButtons,m as NextPrevOutlineButtonsWithEqualWidth,o as Sizes,c as UsingRadioInputs,J as __namedExportsOrder,C as default};
//# sourceMappingURL=Pagination.stories-bcd55b02.js.map
